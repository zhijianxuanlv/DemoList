...
{
    static VerifyView *instance = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        instance = [[self alloc] initWithFrame:CGRectMake(0, 0, 280, 170)];
...
- (void)setup {
    ...
    LCGrayButton *submitBtn = [[LCGrayButton alloc] init];
    submitBtn.translatesAutoresizingMaskIntoConstraints = NO;
    submitBtn.normalColor = RGBColor(245, 51, 51);
    ...
    //对@“view“宽高进行约束 H水平方向 V竖直方向
    NSArray *c1 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[view(200)]"
                                                          options:0
                                                          metrics:nil
                                                            views:views];
    NSArray *c2 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[view(35)]"
                                                          options:0
                                                          metrics:nil
                                                            views:views];
    ...
    NSArray *c4 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[view]-30-[submitBtn(==30)]"
                                                          ...
                                                          metrics:nil
                                                            views:views];
    NSArray *c5 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[cancelBtn(90)]-(>=1)-[submitBtn(==cancelBtn)]"
                                                          options:0
                                                          metrics:nil
                                                            views:views];
    
    NSArray *c6 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[codeField(120)]-0-[resendBtn]-0-|"
                                                          options:0
                                                          metrics:nil
                                                            views:subViews];
